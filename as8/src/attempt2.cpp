...
//     scene.AddComponent<physics>(e).heading = 5;
...
//         physicsComponent.speed = 15; ///// SEG FAULT HERE 
//         physicsComponent.heading = 15;
...
//         // Update the physics component values
//         physicsComponent.speed = speed;
//         physicsComponent.heading = heading;// Perform physics calculations
//         float target = Clamp(targetSpeed, minSpeed, maxSpeed);
//         if (speed < target)
//             speed += acceleration * dt;
//         else if (speed > target)
