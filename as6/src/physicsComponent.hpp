...
struct PhysicsComponent : public Component {
    ...
    void tick(float dt) override {
        ...
        velocity.x = speed * cos(transform.rotation.y * dt);
        velocity.z = -speed * sin(transform.rotation.y * dt);
    ...
    //     velocity.x = speed * cos(axis.y);
    //     velocity.z = -speed * sin(axis.y);
    ...
    //     raylib::Quaternion rotationDelta = raylib::Quaternion::FromAxisAngle(raylib::Vector3{0, 1, 0}, axis.y * dt);
