...
int main() {
    ...
    raylib::Window window(GetMonitorWidth(monitor), GetMonitorHeight(monitor), "CS381 - Assignment 2");//initialize window 
    ...
    const char *Label = {"Press space to begin flying and press left mouse clicker to stop plane "};
    ...
    while (!window.ShouldClose()) {
        ...
        {   
            ...
            {   
                ...
                // Draw skybox, ground, and plane model
                skybox.Draw();
                ground.Draw({});
