...
int main() {
    ...
    while (!window.ShouldClose()) {
        ...
        if (std::abs(rupeePos1.x - position.x) < 50 && std::abs(rupeePos1.y - position.y) < 500) {
            std::cout << "Rupee 1 position reset!" << std::endl;
            rupeePos1 = {0, 0};
        }
        // if (std::abs(rupeePos2.x - position.x) > 5 || std::abs(rupeePos2.y - position.y) > 5) {
        //     rupeePos2 = rupeePos;
        // }
        // if (std::abs(rupeePos3.x - position.x) > 5 || std::abs(rupeePos3.y - position.y) > 5) {
        //     rupeePos3 = rupeePos;
        // }
        // if (std::abs(rupeePos4.x - position.x) > 5 || std::abs(rupeePos4.y - position.y) > 5) {
        //     rupeePos4 = rupeePos;
        // }
        // if (std::abs(rupeePos5.x - position.x) > 5 || std::abs(rupeePos5.y - position.y) > 5) {
        //     rupeePos5 = rupeePos;
        // }


        // Wall boundary 
        if (position.x > 1145) position.x = 1144; // Right boundary
        else if (position.x < -805) position.x = -801; // Left boundary
